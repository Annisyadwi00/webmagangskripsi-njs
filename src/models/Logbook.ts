...
Logbook.init(
  {
    ...
    judul: { type: DataTypes.STRING, allowNull: false, defaultValue: 'Logbook Harian' }, // <-- KOLOM BARU
    ...
    status: { type: DataTypes.ENUM('Pending', 'Disetujui', 'Ditolak'), allowNull: false, defaultValue: 'Pending' },
