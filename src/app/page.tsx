      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} className="overflow-hidden bg-gray-50">
            <div className="px-6 pb-5 pt-2 text-gray-600 leading-relaxed font-medium">
              {answer}
            </div>
          </motion.div>
        )}
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans selection:bg-[#1e3a8a] selection:text-white flex flex-col">
      ...
      <main className="flex-grow">
        {/* HERO SECTION DENGAN EFEK MODERN & TOMBOL MITRA */}
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
          ...
          <div className="absolute top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tr from-emerald-400/10 to-teal-500/10 blur-3xl pointer-events-none"></div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 text-center">
            <motion.div initial="hidden" animate="show" variants={staggerContainer} className="max-w-4xl mx-auto">
              ...
              <motion.h1 variants={fadeUp} className="text-5xl md:text-7xl font-black text-gray-900 mb-6 tracking-tight leading-tight">
                Kelola Magangmu <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#1e3a8a] to-blue-500">Lebih Cerdas & Mudah</span>
              </motion.h1>
              ...
              {/* TOMBOL UTAMA (MAHASISWA) */}
              <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link href="/register" className="w-full sm:w-auto px-8 py-4 bg-[#1e3a8a] text-white font-bold rounded-2xl shadow-lg shadow-blue-900/30 hover:bg-blue-900 transition-all hover:-translate-y-1 hover:shadow-xl text-lg flex items-center justify-center gap-2">
                  Daftar Mahasiswa
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                </Link>
                <Link href="/lowongan" className="w-full sm:w-auto px-8 py-4 bg-white text-gray-700 font-bold rounded-2xl shadow-sm border border-gray-200 hover:bg-gray-50 transition-all hover:-translate-y-1 text-lg flex items-center justify-center gap-2">
                  <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  Lihat Lowongan
                </Link>
              </motion.div>

              {/* PEMISAH & TOMBOL MITRA PERUSAHAAN BARU */}
              <motion.div variants={fadeUp} className="mt-10 pt-8 border-t border-gray-200/60 max-w-lg mx-auto flex flex-col items-center">
                ...
                <Link href="/mitra" className="group flex items-center gap-3 px-6 py-3 bg-blue-50/80 text-[#1e3a8a] font-bold rounded-xl hover:bg-blue-100 transition-colors shadow-sm border border-blue-100/50">
                  <div className="p-1.5 bg-white rounded-lg shadow-sm">
                    <svg className="w-4 h-4 text-[#1e3a8a]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                  </div>
        ...
        <section className="py-24 bg-white relative">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div whileHover={{ y: -10 }} className="p-8 rounded-3xl bg-slate-50 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group">
                <div className="w-14 h-14 bg-blue-100 text-blue-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-[#1e3a8a] group-hover:text-white transition-all">
              ...
              <motion.div whileHover={{ y: -10 }} className="p-8 rounded-3xl bg-slate-50 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group">
                <div className="w-14 h-14 bg-emerald-100 text-emerald-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-emerald-600 group-hover:text-white transition-all">
              ...
              <motion.div whileHover={{ y: -10 }} className="p-8 rounded-3xl bg-slate-50 border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group">
                <div className="w-14 h-14 bg-orange-100 text-orange-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-orange-500 group-hover:text-white transition-all">
        ...
        {/* SECTION FAQ */}
        <section id="faq" className="py-24 bg-gray-50 relative border-t border-gray-100">
        ...
        {/* SECTION STATISTIK */}
        <section className="py-20 bg-[#0f1f4d] text-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
              <div className="p-4">
                <h4 className="text-5xl font-black mb-2 text-blue-300">50+</h4>
                <p className="font-medium text-blue-100/70">Mitra Perusahaan</p>
              </div>
              <div className="p-4">
                <h4 className="text-5xl font-black mb-2 text-blue-300">200+</h4>
                <p className="font-medium text-blue-100/70">Mahasiswa Magang</p>
              </div>
              <div className="p-4">
                <h4 className="text-5xl font-black mb-2 text-blue-300">100%</h4>
                <p className="font-medium text-blue-100/70">Digitalisasi Laporan</p>
              </div>
              <div className="p-4">
                <h4 className="text-5xl font-black mb-2 text-blue-300">20</h4>
                <p className="font-medium text-blue-100/70">SKS Maks. Konversi</p>
              </div>
            </div>
          </div>
        </section>
