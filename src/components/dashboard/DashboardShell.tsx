...
const navItems: Record<DashboardRole, NavItem[]> = {
  ...
  Admin: [
    ...
    { label: 'Pengajuan Lowongan', href: '/admin/pengajuan-lowongan' },
  ...
  'Super Admin': [
    ...
    { label: 'Indikator Penilaian', href: '/super-admin/indikator-penilaian' },
    { label: 'Pengajuan Mitra', href: '/super-admin/pengajuan-mitra' },
    { label: 'Pengajuan Lowongan', href: '/super-admin/pengajuan-lowongan' },
